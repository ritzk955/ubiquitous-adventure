...
public class Reg_Main_Docinfo extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        but1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1=new Intent(Reg_Main_Docinfo.this,Reg_Main.class);
                startActivity(int1);
            }
        });
        ...
        fnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int2=new Intent(Reg_Main_Docinfo.this,Reg_Main_Docadd.class);
                startActivity(int2);
            }
        });
        ...
        mauth.createUserWithEmailAndPassword(email, mobile).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Reg_Main_Docinfo.this, "Failed Registration: "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private  void pushvalue(){
        ...
        dbref.child("Doc Info").push().setValue(datamap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
