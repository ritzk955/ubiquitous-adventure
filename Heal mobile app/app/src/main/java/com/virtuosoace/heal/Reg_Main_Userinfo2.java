...
public class Reg_Main_Userinfo2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        but1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1=new Intent(Reg_Main_Userinfo2.this,Reg_Main_Userinfo1.class);
                startActivity(int1);
            }
        });
        ...
        but2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int2=new Intent(Reg_Main_Userinfo2.this,Reg_Main_Userinfo3.class);
                startActivity(int2);
            }
        });
    }
